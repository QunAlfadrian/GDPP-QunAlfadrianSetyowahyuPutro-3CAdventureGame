...
public class CameraManager : MonoBehaviour {
    ...
    [SerializeField] private Transform _thirdPersonTrackingTarget;

    public bool IsBlending => _cinemachineBrain.IsBlending;
    ...
    public void EmptyTPSTarget() {
        _tpsCamera.LookAt = null;
    }

    public void SetTPSTarget() {
        _tpsCamera.LookAt = _thirdPersonTrackingTarget;
    }
}
